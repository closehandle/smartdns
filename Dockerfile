...
RUN apk add --no-cache openssl-libs-static linux-headers openssl-dev build-base bash curl wget git
...
RUN git clone https://github.com/pymumu/smartdns -b Release47.1 --depth 1 --single-branch smartdns && cd smartdns && \
